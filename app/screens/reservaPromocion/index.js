...
import { Image, ScrollView, View, Text, TouchableOpacity, Animated, Easing } from 'react-native';
import { useSelector } from 'react-redux';
import { Header, ReservaModal } from '../../components';
import { AppStyles, Images } from '../../constants';
import styles from '../reservas/styles';
import { AppText, FlexWrapper, Loader } from '../../components/styled-components';
...
function ReservaHoraFechaScreen(data) {
    ...
    const idActividad = data.route.params.data.actividadId;
...
console.log(data.route.params.data, 'valores -------------------------------------------------------------------------.......................................')
...
const consultaHora = (hora, dia) => {
    ...
    return (
        <>
            ...
            {visibleModal && <ReservaModal onClose={() => {{ setVisibleModal(false); setSelected(false); }}} data={modalData} fecha={date} nombre={nombre} idActividad={idActividad} horadata={datohr(modalData)} imagen={img} modalidad={modalidades} arancel={arancel} precio={precioPromocional} detalle={detalle} />}
