...
const TrackModal = ({
    ...
    const puntototal = safeGetOr("", "puntos")(resumen);
    const puntosNecesarios = data.puntos.slice(1, 5)
    const puntosDescontar = data.puntos
            ...
            <View style={styles.body}>
                <View style={styles.container}>
                    ...
                    <View style={styles.mainContainer}>
                        ...
                        <AppText style={styles.title}>{data.item}</AppText>
                        <Space />

                        <View>
                            <AppText style={styles.label}>Puntos: {data.puntos.slice(1, 5)}</AppText>
                        </View>


                        <View >
                        <AppText style={styles.right}>Términos y Condiciones:</AppText>
                        <Space />
                        
                        <ScrollView>
                        <AppText style={styles.label1}>{data.detalle}</AppText>
                        <Space />
                        <AppText style={styles.label1}>Para validar el cupón solamente debés hacer referencia cuando te enviemos la factura al mail, así de esta manera deduciremos el valor indicado.</AppText>
                        </ScrollView>
                        ...
                        <Button
                        text={"Canjear"}
                        onPress={registerAlertarCompras}
                        disabled={!display}
                    />
                        <Space />
                    </View>
