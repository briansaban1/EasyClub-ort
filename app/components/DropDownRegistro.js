...
function DropDownInputRegistro({ label, onSelect, value, containerStyle = {}, options = [], ...props }) {
    ...
    return (
        <View style={[containerStyle, styles.container]}>
            ...
            <ModalDropdown
                ...
                dropdownStyle={{
                    width: Dimensions.deviceWidth - Dimensions.px100,
                    height: 160,
...
export default DropDownInputRegistro